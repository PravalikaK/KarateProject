...
Feature: JMS REST API - Test Suite 3
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://pravalika.input"
    And header Connection = "Keep-Alive"
    And request "Hi Techies, Karate - JMS"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/pravalika.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi Techies, Karate - JMS"
